import { aws_s3, aws_cloudfront, aws_cloudfront_origins, aws_s3_deployment, CfnOutput, RemovalPolicy } from 'aws-cdk-lib';
...
export class DeploymentService extends Construct {
  constructor(scope: Construct, id: string) {
    ...
    new aws_s3_deployment.BucketDeployment(this, 'BucketDeployment', {
      ...
      distribution,
      // invalidate cache for this s3 as all files have changed
      distributionPaths: ['/*'],
    });
